...
## Move nova compute_driver from networking_vsphere to nova package
#mkdir -p %{buildroot}%{python2_sitelib}/nova/virt/vmwareapi/
#rm -f %{buildroot}%{python2_sitelib}/%{srcname}/nova/virt/vmwareapi/__init__.py*
#mv %{buildroot}%{python2_sitelib}/%{srcname}/nova/virt/vmwareapi/* %{buildroot}%{python2_sitelib}/nova/virt/vmwareapi/
#rm -rf %{buildroot}%{python2_sitelib}/%{srcname}/nova/
...
%exclude %{python2_sitelib}/nova/virt/vmwareapi/
